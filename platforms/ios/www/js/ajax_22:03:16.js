...
function createDetailsPage() {
  var detailsPage = '<div data-role="page" id="details"><div data-role="header"><h1>Emotional Analyzer - Details</h1><a href="#" id="close_details" class="ui-btn ui-btn-inline ui-shadow ui-corner-all ui-btn-a ui-icon-delete ui-btn-icon-left">Close</a></div><div role="main" class="ui-content"><div class="details graph-holder"><canvas id="graphA"></canvas><canvas id="graphB"></canvas><canvas id="graphC"></canvas></div><div class="details list-holder"></div></div><div data-role="footer"><h4>Footer Text</h4></div></div>';
